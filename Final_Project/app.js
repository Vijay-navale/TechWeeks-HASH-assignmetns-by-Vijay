...
const getVoices = () => {
  ...
  voices.forEach((voice) => {
    //looping over through all languages and each voice is an object have couple of properties
...
const createBox = (item) => {
  ...
  const {
    //destructuring item object which is coming from data array one by one
    image,
    text,
  } = item;
